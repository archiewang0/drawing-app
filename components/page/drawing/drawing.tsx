...
const DrawingComponent: FC<pageProps> = ({}) => {
    ...
    const handleMouseUp = (e: MouseEvent) => {
        ...
        if (selectedElement) {
            if (selectedElement.type === ToolModeEnum.text && clientX - selectedElement.offsetX === selectedElement.x1 && clientY - selectedElement.offsetY === selectedElement.y1) {
    ...
    return (
        <div>
            {session?.user && (
                <div className=" mb-5 flex justify-between items-center pb-2 border-b border-black/10">
                    <input
                        type="text"
                        className=" w-1/2 placeholder:text-gray-800 text-2xl font-bold focus:outline-none"
                        placeholder="未命名"
                        onChange={(e) => {
            ...
            <div className=" bg-white flex flex-wrap w-full overflow-hidden">
                ...
                {action === ActionEnum.writing && selectedElement && canvasTop && canvasLeft && (
                    <TextArea
                ...
                <div
                    ...
                    style={{height: '650px'}}
                    className="relative border border-gray-300 rounded-md overflow-hidden w-full">
                    {loaded && (
                        <Canvas
                            canvasRef={canvasRef}
